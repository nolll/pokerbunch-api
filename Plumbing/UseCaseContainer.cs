...
namespace Plumbing
{
    public class UseCaseContainer
    {
        ...
        // Locations
        public GetLocationList GetLocationList => new GetLocationList(_deps.BunchService, _deps.UserService, _deps.PlayerService, _deps.LocationRepository);
        public GetLocation GetLocation => new GetLocation(_deps.LocationRepository, _deps.UserService, _deps.PlayerService, _deps.BunchService);
