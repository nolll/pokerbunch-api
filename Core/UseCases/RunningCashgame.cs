...
namespace Core.UseCases
{
    public class RunningCashgame
    {
        ...
        public RunningCashgame(BunchService bunchService, CashgameService cashgameService, PlayerService playerService, IUserRepository userRepository, ILocationRepository locationRepository)
        {
