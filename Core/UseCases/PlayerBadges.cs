...
namespace Core.UseCases
{
    public class PlayerBadges
    {
        ...
        public PlayerBadges(IBunchRepository bunchRepository, CashgameService cashgameService, IPlayerRepository playerRepository, IUserRepository userRepository)
        {
