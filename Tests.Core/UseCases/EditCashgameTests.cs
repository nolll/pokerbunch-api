...
public class EditCashgameTests : TestBase
{
    ...
    {
        var request = new EditCashgame.Request(new AccessControlInTest(canEditCashgame: true), TestData.CashgameIdA, null, null);
    ...
    {
        var request = new EditCashgame.Request(new AccessControlInTest(canEditCashgame: true), TestData.CashgameIdA, TestData.ChangedLocationId, null);
    ...
    {
        var request = new EditCashgame.Request(new AccessControlInTest(canEditCashgame: true), TestData.CashgameIdA, TestData.ChangedLocationId, "1");
        await Sut.Execute(request);
