...
If you don't have an account, you can register at https://pokerbunch.com/test";
    ...
    private static InvitePlayer.Request CreateRequest(string email = TestData.UserEmailA)
    {
        ...
        return new InvitePlayer.Request(new AccessControlInTest(canInvitePlayer: true, currentBunch: currentBunch), TestData.PlayerIdA, email, TestData.TestUrl, "https://pokerbunch.com/fakejoin/{0}", "https://pokerbunch.com/fakejoin/{0}/{1}");
    }
