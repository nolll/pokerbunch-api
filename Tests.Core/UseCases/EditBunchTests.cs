...
public class EditBunchTests : TestBase
{
    ...
    {
        var request = new EditBunch.Request(new PrincipalInTest(canEditBunch: true), TestData.SlugA, Description, "", ValidCurrencyLayout, ValidTimeZone, HouseRules, DefaultBuyin);
    ...
    {
        var request = new EditBunch.Request(new PrincipalInTest(canEditBunch: true), TestData.SlugA, Description, ValidCurrencySymbol, "", ValidTimeZone, HouseRules, DefaultBuyin);
        var result = await Sut.Execute(request);
    ...
    {
        var request = new EditBunch.Request(new PrincipalInTest(canEditBunch: true), TestData.SlugA, Description, ValidCurrencySymbol, ValidCurrencyLayout, "", HouseRules, DefaultBuyin);
        var result = await Sut.Execute(request);
    ...
    {
        var request = new EditBunch.Request(new PrincipalInTest(canEditBunch: true), TestData.SlugA, Description, ValidCurrencySymbol, ValidCurrencyLayout, "invalid", HouseRules, DefaultBuyin);
        var result = await Sut.Execute(request);
    ...
    {
        var request = new EditBunch.Request(new PrincipalInTest(canEditBunch: true), TestData.SlugA, Description, ValidCurrencySymbol, ValidCurrencyLayout, ValidTimeZone, HouseRules, DefaultBuyin);
